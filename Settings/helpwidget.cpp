...
HelpWidget::HelpWidget(QWidget *parent) :
    QWidget(parent), ui(new Ui::HelpWidget), darkMode(false)
{
    ui->setupUi(this);
    ...
    ui->label->setStyleSheet("font: 20pt \"华文中宋\"; color: rgb(0, 0, 0); background-color: rgb(170, 255, 255);");
...
void HelpWidget::setDarkMode(bool mode) {
    darkMode = mode;
    if (mode == false) {
        setStyleSheet("background-color: rgb(170, 255, 255);");
        ui->label->setStyleSheet("font: 20pt \"华文中宋\"; color: rgb(0, 0, 0); background-color: rgb(170, 255, 255);");
