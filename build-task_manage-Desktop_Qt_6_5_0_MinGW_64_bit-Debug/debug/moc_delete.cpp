...
static constexpr auto qt_meta_stringdata_CLASSDeleteENDCLASS = QtMocHelpers::stringData(
    "Delete",
    "showMain",
    "",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSDeleteENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSDeleteENDCLASS_t qt_meta_stringdata_CLASSDeleteENDCLASS = {
    {
        QT_MOC_LITERAL(0, 6),  // "Delete"
        QT_MOC_LITERAL(7, 8),  // "showMain"
        QT_MOC_LITERAL(16, 0),  // ""
...
void Delete::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Delete::showMain; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
